  ...
  <main class="main-content mt-0 vh-100" style="">
    <section>
      <div class="page-header min-vh-75">
        <div class="container">
          <div class="card m-auto mt-8 p-3 loginnih">
            <div class="card-body">
              ...
              <div>
                <button type="button" class="btn w-100 btn-success mt-2" @click="redirectPage()">Don't have an account? register here</button>
              </div>
            </div>
          </div>
        </div>
