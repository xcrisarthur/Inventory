    ...
    <form @submit.prevent="createRepair">
      <div class="row row-cols-2 row-cols-lg-3 g-lg-3">
        ...
        <div class="mb-3 col">
          ...
          <input v-model="newRepair.tanggal_kerusakan" type="text" class="form-control" id="tanggal_kerusakan" required>
        </div>
        <div class="mb-3 col">
          <label for="tanggal_selesai_perbaikan" class="form-label">tanggal_selesai_perbaikan</label>
          <input v-model="newRepair.tanggal_selesai_perbaikan" type="text" class="form-control"
